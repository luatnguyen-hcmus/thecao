...
<div class="wrapper">
				...
				<div class="widget">
					...
					<div class="tab_container">
					     <div id="tab1" class="tab_content pd0">
							...
							<div class="formRow">
								...
								<div class="formRight">
									<div class="left">
										...
										<img width="100px" height="70px;" src="<?php echo base_url('upload/news/'.$news->image_link) ?>" >
									</div>
							...
							<!-- <?php $image_list = json_decode($news->image_list) ;?>
							<div class="formRow">
									...
									<div class="left">
										...
										<?php if(is_array($image_list)) :?>
											<?php foreach($image_list as $img) :?>
												<img style="margin:5px;" width="100px" height="70px;" src="<?php echo base_url('upload/news/'.$img) ?>" >
											<?php endforeach ?>
										<?php endif?>
									</div>
 ...
 -->
							...
							<!-- <div class="formRow">
								...
								<div class="formRight">
									<span class="oneTwo">
										<input name="price" value="<?php echo $news->price ?>" style="width:100px" id="param_price" class="format_number" _autocheck="true" type="text">
							...
							<div class="formRow">
								...
								<div class="formRight">
									<span>
										<input name="discount" value="<?php echo $news->discount ?>" style="width:100px" id="param_discount" class="format_number" type="text">
											...
											<?php if(count($row->subs) > 1) :?>
											    <optgroup label="<?=$row->name?>">	
											    	<?php foreach($row->subs as $sub) :?>				                    
											    		<option value="<?=$sub->id?>" <?php if($sub->id == $news->catalog_id) echo 'selected';?>>
											    			<?=$sub->name?>
											    		</option>
											    	<?php endforeach?>
											    </optgroup>
											 ...
											 <?php else : ?>
											 	<option value="<?php echo $row->id ?>" <?php if($row->id == $news->catalog_id) echo 'selected';?>>
											 		<?php echo $row->name ?>
											 	</option>
											<?php endif;?>
									    <?php endforeach;?>
							...
							<!-- <div class="formRow">
								...
								<div class="formRight">
									<span class="oneFour"><input name="warranty" id="param_warranty" type="text" value="<?php echo $news->warranty ?>"></span>
							...
							<div class="formRow">
								...
								<div class="formRight">
									<span class="oneTwo"><textarea name="gifts" id="param_sale" rows="4" cols="" > <?php echo $news->gifts?></textarea></span>
							...
							<!-- <div class="formRow">
								...
								<div class="formRight">
									<span class="oneTwo"><textarea name="site_title" id="param_site_title" _autocheck="true" rows="4" cols=""><?php echo $news->site_title?></textarea></span>
