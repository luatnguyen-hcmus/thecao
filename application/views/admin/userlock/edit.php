...
<div class="wrapper">
	<div class="widget">
		...
		<form class="form" id="form" action="" method="post" enctype="multipart/form-data">
			<fieldset>
				<div class="formRow">
					<label class="formLeft" for="param_email">Username:<span class="req">*</span></label>
					<div class="formRight">
						<span class="oneTwo"><input name="user" id="param_user" value="<?php echo $user->user_name ?>" _autocheck="true" type="text" readonly></span>
					...
					<div class="formRight">
						<span class="oneTwo">
							<span> 
								<p>
									Họat động
									<input name="status" value="1" id="param_status_show" _autocheck="true" type="radio" <?php if($user->status == 1) echo 'checked'; else echo '' ?> />
								</p>
							</span>
							<span>	
								<p>
									Bị khóa
									<input name="status" value="0" id="param_status_hide" _autocheck="true" type="radio" <?php if($user->status == 0) echo 'checked'; else echo '' ?> />
								</p>
							</span>
						</span>
						<span name="name_autocheck" class="autocheck"></span>
